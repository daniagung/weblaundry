...
// Don't duplicate me!
if( !class_exists( 'DethemeReduxFramework_color_rgba' ) ) {
     ...
     * @since       1.0.0
     */
    class DethemeReduxFramework_color_rgba extends DethemeReduxFramework {
       ...
       */
        ...
        public function render() {
            ...
            if ('' == $this->value['color'] || 'transparent' == $this->value['color']) {
                ...
                $color = self::hex2rgba($this->value['color'], $this->value['alpha']);
            }            

            if ($this->value['rgba'] == ''){
                $this->value['rgba'] = self::hex2rgba($this->value['color'], $this->value['alpha']);
            }
        ...
        public function enqueue() {
            ...
            if (!wp_script_is ( 'redux-field-color-rgba-js' )) {
                ...
                wp_enqueue_script(
                    'redux-spectrum-js',
                    DethemeReduxFramework::$_url . 'assets/js/vendor/spectrum/redux-spectrum.js',
                    array( 'jquery' ),
                    '1.3.3',
                    true
                );
                ...
                wp_enqueue_script(
                    ...
                    DethemeReduxFramework::$_url . 'inc/fields/color_rgba/field_color_rgba.js',
            ...
            if (!wp_style_is ( 'redux-spectrum-css' )) {
                wp_enqueue_style(
                    'redux-spectrum-css',
                    DethemeReduxFramework::$_url . 'assets/css/vendor/spectrum/redux-spectrum.css',
                    array(),
                    "",
                    'all'
                );
            ...
            //if ($this->parent->args['dev_mode']) {
                if (!wp_style_is ( 'redux-field-color-rgba-css' )) {
                    wp_enqueue_style(
                        ...
                        DethemeReduxFramework::$_url . 'inc/fields/color_rgba/field_color_rgba.css',
                        array(),
                        "",
                        'all'
                    );
            ...
            if (is_array($this->value)) {
                ...
                foreach($this->value as $id => $val) {
                    ...
                    if ($id == 'alpha') {
                        ...
                        $rgba = !empty($val) ? $val : '';
                        $rgba = self::hex2rgba($color, $alpha);
                    }
                }
        ...
        public function output() {
            if (!empty($this->value)) {
                ...
                if ( ! empty( $this->field['output'] ) && is_array( $this->field['output'] ) ) {
                    $css = self::parseCSS( $this->field['output'], $style, $color_val );
                    $this->parent->outputCSS .= $css;
                }

                if ( ! empty( $this->field['compiler'] ) && is_array( $this->field['compiler'] ) ) {
                    $css = self::parseCSS( $this->field['compiler'], $style, $color_val );
