...
//                $comparison = $field['required'][1];
        ...
        function admin_toolbar($wp_admin_bar){
            ...
            if(current_user_can($this->args['page_cap']) && !is_admin()){

                $option_link=add_query_arg('page',$this->args['page_slug'], admin_url("/themes.php"));
...
//                }
                        ...
                        if( isset( $field['type'] ) && $field['type'] != 'callback' ) {
                            ...
                            if( $class_file ) {
                                ...
                                if ( method_exists( $field_class, 'enqueue' ) || method_exists( $field_class, 'localize' ) ) {
                                    ...
                                    if ( class_exists($field_class) && method_exists( $field_class, 'admin_enqueue' ) ) {
                                        /** @noinspection PhpUndefinedMethodInspection */
                                        $theField->admin_enqueue();    
                                    }
        ...
        public function _register_setting() {
            ...
            if(($pagenow=='themes.php'  && $this->args['page_slug']==(isset($_GET['page'])?$_GET['page']:"") ) || isset($_POST[$this->args['opt_name']])){
               ...
               return $this->_get_theme_info(get_option('cleanco_license_'.get_template()));
            }
...
//                return $this->options;
        ...
        public function _options_page_html() {
            ...
            $this->_get_detheme_update(get_option("cleanco_license_".get_template()));
