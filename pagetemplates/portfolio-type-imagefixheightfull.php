...
<div class="row" >
	<div id="portfolios" data-type="imagefixheightfull" data-col="<?php print esc_attr($column);?>" class="portfolio-container">
...
<?php
			...
			print '<a class="button btn-more more-post" href="'.esc_url($nav_link).'page=2">'.__('Load More','cleanco').'</a>'."\n";
