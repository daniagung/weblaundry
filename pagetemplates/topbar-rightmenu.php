...
$menu=get_cleanco_option('dt-right-top-bar-menu','');
...
?>
      <div class="right-menu">
            ...
            <div id="mobile-header-top-right" class="visible-sm-min visible-xs">
                  <label for="main-nav-check-top-right" class="toggle" onclick="" title="<?php _e('Menu','cleanco');?>"><i class="icon-menu"></i></label>
            </div><!-- closing "#header" -->
      </div>
<?php
      } else {
