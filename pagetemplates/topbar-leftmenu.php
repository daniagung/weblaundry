...
$menu=get_cleanco_option('dt-left-top-bar-menu','');
...
?>
      <div class="left-menu">
            ...
            <div id="mobile-header-top-left" class="visible-sm-min visible-xs">
                  <label for="main-nav-check-top-left" class="toggle" onclick="" title="<?php _e('Menu','cleanco');?>"><i class="icon-menu"></i></label>
            </div><!-- closing "#header" -->
      </div>
<?php
      } else {
