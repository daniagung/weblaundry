...
if(version_compare(WPB_VC_VERSION,'4.8.0','<')){
    ...
    if(''!==$customcss){
        $cleanco_Style[]=".".$excss."{".$customcss."}";
    }


    if(''!=$font_color){
        $cleanco_Style[]=".".$excss." .dt-counto:after {background-color: ".$font_color." }";
        $cleanco_Style[]=".".$excss." h1,.".$excss." h2,.".$excss." h3,.".$excss." h4,.".$excss." h5,.".$excss." h6,.".$excss." .progress_number{color: ".$font_color." }";
    }
