...
if(isset($_GET['posts_per_page'])){
	set_query_var('posts_per_page',intval($_GET['posts_per_page']));
}
...
if('imagefixheightfull'==$type || 'vcimage'==$type){
		...
		<?php
				...
				print '<a class="button btn-more more-post" href="'.esc_url($nav_link).'">'.__('Load More','cleanco').'</a>'."\n";
		...
		set_query_var('post__not_in',esc_sql(trim($_GET['in'])));
		...
		<?php
					...
					print '<a class="button btn-more more-post '.sanitize_html_class(get_query_var( 'portcat' )).'" href="'.esc_url($nav_link).'">
