...
if($featured_image){
	...
	if(!$image=aq_resize($featured_image[0], 0,$imageSize, false, false)){
...
<div class="post-image-container">
	...
	<div class="post-image">
		<img class="simg-responsive" data-width="<?php print esc_attr($image[1]);?>" width="<?php print esc_attr($image[1]);?>" data-height="<?php print esc_attr($image[2]);?>" src="<?php echo esc_url($image[0]); ?>" alt="<?php echo esc_attr($alt_image);?>" />
	</div>
	<?php endif;?>
