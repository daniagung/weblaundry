...
<div class="<?php echo sanitize_html_class($class_sidebar);?>">
	<div class="container">
		...
		<h1 class="page-title"><?php print esc_attr(get_cleanco_option('page-title',''));?></h1>
		<?php endif;?>
		<div class="row">
...
while ( have_posts() ) : 
	...
	<div class="<?php echo sanitize_html_class($reveal_area_class); ?>"></div>
...
<?php if(comments_open() && (get_cleanco_option('page-comment-open','')==1)):?>
